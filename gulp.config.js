...
module.exports = {
	...
	// Project options.
	projectURL: process.env.DEVELOPMENT_DOMAIN, // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'BSA-Scaffold', // Your textdomain here.
	translationFile: 'BSA-Scaffold.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'BSA-Scaffold', // Package name.
